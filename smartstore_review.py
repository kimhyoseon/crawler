...
class SmartstoreReview(Crawler):
    ...
    def get_review_message(self, review_text, item_name):
        try:
            ...
            elif '효과' in review_text or '도움' in review_text or '시원' in review_text and '아직' not in review_text  and '더' not in review_text:
            ...
            if '냄새' in review_text and '없' not in review_text and '안나' not in review_text and '날라' not in review_text and '심' not in review_text and '거의' not in review_text and '크게' not in review_text:
