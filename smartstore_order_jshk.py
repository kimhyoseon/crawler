...
class SmartstoreOrderJshk(Crawler):
    ...
    def scan_page(self):
        try:
            ...
            # 새로고침
            if self.connect(site_url='https://sell.smartstore.naver.com/#/naverpay/sale/delivery?summaryInfoType=DELIVERY_READY', is_proxy=False, default_driver='selenium', is_chrome=True) is False:
